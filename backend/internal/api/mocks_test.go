...
func (_mock *mockdocumentIndex) Search(query string, tags []string, skip int64, limit int64, sortField string, sortOrder int, privateOnly bool, isAuthenticated bool) domain.PagedSearchResult {
	ret := _mock.Called(query, tags, skip, limit, sortField, sortOrder, privateOnly, isAuthenticated)
	...
	if returnFunc, ok := ret.Get(0).(func(string, []string, int64, int64, string, int, bool, bool) domain.PagedSearchResult); ok {
		r0 = returnFunc(query, tags, skip, limit, sortField, sortOrder, privateOnly, isAuthenticated)
	} else {
...
func (_e *mockdocumentIndex_Expecter) Search(query interface{}, tags interface{}, skip interface{}, limit interface{}, sortField interface{}, sortOrder interface{}, privateOnly interface{}, isAuthenticated interface{}) *mockdocumentIndex_Search_Call {
	return &mockdocumentIndex_Search_Call{Call: _e.mock.On("Search", query, tags, skip, limit, sortField, sortOrder, privateOnly, isAuthenticated)}
}

func (_c *mockdocumentIndex_Search_Call) Run(run func(query string, tags []string, skip int64, limit int64, sortField string, sortOrder int, privateOnly bool, isAuthenticated bool)) *mockdocumentIndex_Search_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *mockdocumentIndex_Search_Call) RunAndReturn(run func(query string, tags []string, skip int64, limit int64, sortField string, sortOrder int, privateOnly bool, isAuthenticated bool) domain.PagedSearchResult) *mockdocumentIndex_Search_Call {
	_c.Call.Return(run)
	return _c
}
